> **Development compatibility:** The current tested Host is official `0.1.5-rc.3`. This checkout contains the adaptation; the published `seektty@1.2.6` release was verified with dsh `0.1.5-rc.1`. See the [rc.2 verification record](docs/dsh-0.1.5-rc.2-adaptation.md) and [original API migration](docs/dsh-0.1.5-rc.1-adaptation.md).
...
The current tested Host is official `0.1.5-rc.3`. The [rc.2 adaptation record](docs/dsh-0.1.5-rc.2-adaptation.md) documents that version's validation. Published release evidence is listed separately below.
