#!/usr/bin/env node
import { a as PACKAGE_VERSION, d as launcherCopy, f as launcherPrefersEnglish, i as PACKAGE_NAME, n as measureStartupSync, o as compareDshVersion, p as versionMessage, r as DSH_COMPATIBILITY, s as defaultPluginSpec, u as isVersionRequest } from "./startup-trace-w_lhUo2q.js";
...
/**
* Query npm and GitHub for the newest dsh and SeekTTY versions.
...
async function scanLatestVersions(fetchImpl = fetch, timeoutMs = DEFAULT_SCAN_TIMEOUT_MS) {
	...
	return {
		...
		dshNext: cleanVersion(tags?.next),
...
* dsh follows the npm `latest` dist-tag unless DSH_BIN pins the executable;
* SeekTTY follows its newest GitHub release tag when it is newer than this
* running copy.
*/
function updatePlan(scan, facts) {
	return {
		dshSpec: !facts.dshPinned && scan.dshLatest !== void 0 ? `@deepseek-ai/dsh@${scan.dshLatest}` : void 0,
