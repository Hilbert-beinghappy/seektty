...
* a guard against accidentally implementing fields that dsh does not expose.
*/
const CURRENT_DSH_SUBAGENT_PRESENTATION_CONTRACT = Object.freeze({
	tested: DSH_COMPATIBILITY.tested,
	required: Object.freeze([
		"SubagentListEntry.kind",
		"SubagentListEntry.id",
		"SubagentAddress.parentSessionId",
		"SubagentAddress.childSessionId",
		"SubagentAddress.mode"
	]),
	optional: Object.freeze([
		"SubagentListEntry.label",
		"SubagentListEntry.activity",
		"SubagentListEntry.hasChildren",
		"SubagentCatalog.parentAvailable",
	...
	unsupported: Object.freeze([
		...
		"terminalLifecycle",
		"taskSummary",
		"permissionOwnerSessionId",
		"publicStatusSubscription"
	])
});
/**
...
export { compareDshVersion as a, dshCompatibilityNotice as c, launcherPrefersEnglish as d, versionMessage as f, PACKAGE_VERSION as i, isVersionRequest as l, HOST_DESCRIBE_VERSION_PLACEHOLDER as n, defaultPluginSpec as o, PACKAGE_NAME as r, dshCompatibilityError as s, DSH_COMPATIBILITY as t, launcherCopy as u };